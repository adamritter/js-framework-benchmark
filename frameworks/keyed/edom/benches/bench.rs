...
use js_framework_benchmark_wasm_bindgen::*;
use rand::prelude::*;
...
criterion_group!{
    ...
    targets = bench_js_framework_benchmark_create10000, bench_box, bench_fold, bench_vec, bench_cached_value_push, bench_cached_value_push_get, bench_cached_value_easy_get
}
// criterion_group!(benches, bench_js_framework_benchmark_create10000, bench_box, bench_fold, bench_vec, bench_cached_value_push, bench_cached_value_push_get, bench_cached_value_easy_get);
